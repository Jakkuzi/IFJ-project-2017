...
void IFJcode17_if(tLinePtr *temp)
{
	...
	printf("JUMPIFNEQS LABELIF%d", labelIf);
...
void IFJcode17_else(tLinePtr *temp)
{
	...
	printf("LABEL LABELIF%d",labelIf);
...
{
	printf("LABEL LABELIFEND%d", labelIf);
...
void IFJcode17_dowhile(tLinePtr *temp)
{
	...
	IFJcode17_evalExprBool(temp);
	printf("PUSHS bool@true\n");
	printf("JUMPIFNEQS LOOPEND%d", labelLoop);
...
{
	printf("JUMP LOOP%d\n", labelLoop);
	printf("LABEL LOOPEND%d", labelLoop);
